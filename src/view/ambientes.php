...
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12">
        ...
        <div class="card">
            <div class="card-body">
                 <a href="<?php BASE_URL;?>reportes-exel/ambientes" class="btn btn-success" title="REPORTE GENERAL"><i class="fa fa-file-excel">EXPORTAR A EXCEL</i></a>
                 <a href="<?php BASE_URL;?>imprimir/imprimirAmbientes" class="btn btn-danger" title="REPORTE GENERAL" ><i class="fa fa-file-pdf"></i>EXPORTAR A PDF</a>
